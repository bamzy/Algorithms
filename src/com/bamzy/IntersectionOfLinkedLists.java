...
There are 2 nodes before the intersected node in A; There are 3 nodes before
...
this must not be 0 if the two lists intersect). From the head of
A, it reads as [0,9,1,2,4]. From the head of B, it reads as [3,2,4].
...
public class IntersectionOfLinkedLists {
    ...
    private LListNode reverse(LListNode headA) {
        LListNode temp = headA, last = null,origNext;
        while (temp != null) {
            origNext = temp.next;
             temp.next = last;
             last = temp;
