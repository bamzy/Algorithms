...
The relative order inside both the even and
...
public class OddEvenLinkedLists {
    ...
    public LListNode oddEvenList(LListNode head) {
        LListNode temp = head, lastOdd=null, lastEven=null,evenBegin=null;
